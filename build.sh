...
function build_lib {
	...
	gcc $1 -c lreduction.c -D_REENTRANT $DEBUG_PARAM -pthread && \
	cd filter && \
	...
	rm -f libpac.a
	ar -crv libpac.a app.o crc.o gpio.o timef.o $SOCK.o util.o tsv.o lcorrection.o lreduction.o filter/ma.o filter/exp.o acp/main.o && echo "library: done" && echo "hardware: $CPU $PINOUT"
	rm -f *.o acp/*.o
}
function build {
	cd lib && \
